...
<template>
  <div class="flex flex-col pt-[30px] h-full" v-if="tickersData">
    <div class="flex flex-col gap-3">
      <div class="text-gray-primary text-base">Transfer amount</div>
    ...
    <div class="flex flex-col gap-3 mt-[30px]">
      <div class="text-gray-primary text-base">TRANSFER Inscriptions ({{ tickersData.transferableList.length }})</div>
    ...
    >
      ...
      <div class="text-gray-primary text-center text-lg">
        Available {{ tickersData.tokenBalance.availableBalance }} {{ symbol }}
      </div>
    </div>
    <div class="mt-2 text-gray-primary text-sm text-center">
